...
"""
to-do tomorrow:
    rebuild fixtures using the example script above - you'll need to monkeypatch
    just make sure your questions are about japan as most of your docs are about japan
    also make sure you have a question about chicago

    also after you do that, you can now just add the hybrid search option (via monkeypatch) to the simplevectorstore class,
    then you can run a vectorstoreindex like above and ask your questions in your koda retriever. it works!
"""
